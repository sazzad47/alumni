...
export default function OverView() {
  ...
  useEffect(() => {
    if (window) {
      const newData = sessionStorage.getItem("registerData");
      if (newData) {
      ...
      >
        ...
        <Grid className="w-full p-5 mt-4 bg-stone-400 dark:bg-zinc-500 flex flex-col">
          <Grid container spacing={2} className="w-full">
            ...
            <Grid item xs={6}>
              <Typography className="p-0">Batch:</Typography>
            </Grid>
            <Grid item xs={6}>
              <Typography className="p-0">{ssc_batch}</Typography>
            </Grid>
            <Grid item xs={6}>
            ...
            <Grid item xs={6}>
              <Typography className="p-0">Membership:</Typography>
            </Grid>
            <Grid item xs={6}>
              <Typography className="p-0">{membership}</Typography>
            </Grid>
