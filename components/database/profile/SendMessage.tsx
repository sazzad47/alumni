...
import { Grid, Typography, TextField, Button, IconButton, Snackbar } from "@mui/material";
...
const SendMessage = ({ data, messageForm, setMessageForm }: UserData) => {
