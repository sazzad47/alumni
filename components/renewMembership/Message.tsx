      ...
      <Container component="main" className="flex items-center justify-center">
        ...
        >
          ...
          <Grid className="w-full p-5 mt-4 bg-stone-400 dark:bg-zinc-500 flex flex-col">
            ...
            {`${payment === "successful"? "We received your payment. Your membership has been renewed. Please login to make use of the alumni facilities immediately. Thank you.": "We didn't receive your payment. Please try again with valid information. "}`}
            </Typography>
          </Grid>
