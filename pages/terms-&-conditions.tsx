    ...
    <React.Fragment>
      ...
      <main>
        <div className="p-5 min-h-[90vh] flex flex-col gap-5 items-center justify-start bg-slate-200 dark:bg-zinc-800 text-slate-900 dark:text-slate-200">
          ...
          <TermsConditions data={acceptedData} />
        </div>
      </main>
    </React.Fragment>
  );
...
export const getServerSideProps: GetServerSideProps<Props> = async () => {
  const id = "6408c21e248c5addb0770386";
  // "6408c235248c5addb0770388"
  // "6408c261248c5addb077038a"
  // "6408c28d248c5addb077038c"
  // "6408c2a6248c5addb077038e"
  // "6408c2d4248c5addb0770390"
  // "6408c2ec248c5addb0770392"
